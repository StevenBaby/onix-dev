...
#define element_offset(type, member) (u64)(&((type *)0)->member)
#define element_entry(type, member, ptr) (type *)((u64)ptr - element_offset(type, member))
#define element_node_offset(type, node, key) ((u64)(&((type *)0)->key) - (u64)(&((type *)0)->node))
#define element_node_key(node, offset) *(u64 *)((u64)node + offset)
